...
<div class="theme-layout">
	...
	<div class="responsive-header">
		<div class="logo res"><img src="{{asset('/frontend/images/logo.png')}}" alt=""><span>Socimo</span></div>
		<div class="user-avatar mobile">
			<a href="" title="View Profile"><img alt="" src="{{asset('/frontend/images/resources/user.jpg')}}"></a>
			<div class="name">
				<h4>ITNA GROUP</h4>
...
<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></span>
	...
	<form  action="{{url('/search/')}}" method="Get">
			...
			<a href="showfriendrequest">Total Friend Request
				{{App\addFriend::where(['status'=>null], ['acceptor', Auth::user()->id])->count()}}
			</a>
	<header class="">
		<div class="topbar stick">
			<div class="logo"><img src="" alt=""><a href="{{route('frontend.home')}}"><span>AemalWorld</span></a></div>
			<div class="searches">
				<form method="post">
						...
						<ul class="so-history">
							<li>
								<div class="searched-user">
									<figure><img src="{{asset('/frontend/images/resources/user1.jpg')}}" alt=""></figure>
							...
							<li>
								<div class="searched-user">
									<figure><img src="{{asset('/frontend/images/resources/user2.jpg')}}" alt=""></figure>
									<span>Maria K</span>
								</div>
								<span class="trash"><i class="icofont-close-circled"></i></span>
							</li>
							<li>
								<div class="searched-user">
									<figure><img src="{{asset('/frontend/images/resources/user3.jpg')}}" alt=""></figure>
			...
			<ul class="web-elements">
				<li>
					<div class="user-dp">
						<a href="{{url('home/profile/'. Auth::user()->id)}}" title="">
							<img alt="" src="{{asset('/frontend/images/resources/user.')}}jpg">
							<div class="name">
...
<svg fill="#f00" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 32 32" width="18px" height="18px"><path d="M 6.1015625 6.1015625 C 3.5675625 8.6345625 2 12.134 2 16 C 2 19.866 3.5675625 23.365437 6.1015625 25.898438 L 7.5195312 24.480469 C 5.3465312 22.307469 4 19.308 4 16 C 4 12.692 5.3465312 9.6925313 7.5195312 7.5195312 L 6.1015625 6.1015625 z M 25.898438 6.1015625 L 24.480469 7.5195312 C 26.653469 9.6925312 28 12.692 28 16 C 28 19.308 26.653469 22.307469 24.480469 24.480469 L 25.898438 25.898438 C 28.432437 23.365437 30 19.866 30 16 C 30 12.134 28.432437 8.6345625 25.898438 6.1015625 z M 9.6367188 9.6367188 C 8.0077188 11.265719 7 13.515 7 16 C 7 18.485 8.0077187 20.734281 9.6367188 22.363281 L 11.052734 20.947266 C 9.7847344 19.680266 9 17.93 9 16 C 9 14.07 9.7847344 12.319734 11.052734 11.052734 L 9.6367188 9.6367188 z M 22.363281 9.6367188 L 20.947266 11.052734 C 22.215266 12.319734 23 14.07 23 16 C 23 17.93 22.215266 19.680266 20.947266 20.947266 L 22.363281 22.363281 C 23.992281 20.734281 25 18.485 25 16 C 25 13.515 23.992281 11.265719 22.363281 9.6367188 z M 16 12 A 4 4 0 0 0 16 20 A 4 4 0 0 0 16 12 z"/></svg></i>
				...
				<li>
					<a href="{{route('frontend.home')}}" title="Home" data-toggle="tooltip">
						<i>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
					...
					<ul class="dropdown">
						<li><a href="{{url('home/profile/'. Auth::user()->id)}}" title=""><i class="icofont-user-alt-3"></i> Your Profile</a></li>
						<li><a href="{{route('BusinessPage.index')}}" title=""><i class="icofont-plus"></i> New Business Page</a></li>
						<li><a class="invite-new" href="#" title=""><i class="icofont-brand-slideshare"></i> Invite Collegue</a></li>
						<li><a href="{{url('home/wallet/'. Auth::user()->id)}}" title=""><i class="icofont-price"></i> Wallet</a></li>
						<li><a href="{{url('home/boost/'. Auth::user()->id)}}" title=""><i class="icofont-flash"></i> Boosting Service</a></li>
		...
		<ul class="menu-slide">
			<li class="active menu-item-has-children">
				...
				<ul class="submenu">
					...
					<li><a href="{{route('dashboard.profile')}}" title="">Student User Profile</a></li>
...
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg></i> Web Settings
	...
	<svg id="side-menu" xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-menu"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></i>
						...
						<div class="col-lg-8">
							<div class="page-caro">
								<div class="link-item">
									<a class="active" href="{{route('frontend.home')}}" title="">
										<i class="">
...
{{--	<figure class="bottom-mockup"><img src="{{asset('/frontend/images/footer.png')}}" alt=""></figure>--}}

    <footer>
        <div class="gap">
            <div class="bg-image" style="background-image: url({{asset('/frontend/images/resources/footer-bg.png')}})"></div>
            <div class="container">
                <div class="row">
	...
	<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<span class="">&copy; copyright All rights reserved by Itna Group | 2022 |</span>
				</div>
			</div>
		</div>
	</div><!-- bottombar -->
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg></i>Create New Post</h5>
				...
				<div class="post-new">
					<div class="post-newmeta">
						...
						<form method="get" action="{{route('userPost.index')}}" enctype="multipart/form-data" class="dropzone">
							<div class="fallback">
					...
					<form method="post" class="c-form">
						<textarea id="emojionearea1" name="caption" placeholder="What's On Your Mind?"></textarea>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-help-circle"><circle cx="12" cy="12" r="10"></circle><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path><line x1="12" y1="17" x2="12.01" y2="17"></line></svg></i> Ask Question</h5>
	...
	<div class="cart-product">
		<a href="{{route('cart-product')}}" title="View Cart" data-toggle="tooltip"><i class="icofont-cart-alt"></i></a>
		<span>03</span>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share-2"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg></i>
	...
	<script src="{{asset('frontend/js/main.min.js')}}"></script><!-- vendors merged files -->
	<script src="{{asset('frontend/js/date-time.js')}}"></script>
