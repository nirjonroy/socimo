							...
							<div class="col-lg-3">
								<aside class="sidebar static left">
									<div class="widget whitish low-opacity">
										<img src="{{asset('/frontend/images/time-clock.png')}}" alt="">
										<div class="bg-image" style="background-image: url({{asset('/frontend/images/resources/time-bg.jpg')}})"></div>
										<div class="date-time">
											<div class="realtime">
									...
									<div class="advertisment-box">
										...
										<figure>
											<a href="#" title="Advertisment"><img src="{{asset('/frontend/images/resources/ad-widget2.jpg')}}" alt=""></a>
										</figure>
									...
									<div class="widget">
										...
										<ul class="premium-course">
											<li>
												<figure>
													<img src="{{asset('/frontend/images/resources/course-5.jpg')}}" alt="">
											...
											<li>
												<figure>
													<img src="{{asset('/frontend/images/resources/course-3.jpg')}}" alt="">
							...
							<div class="col-lg-6">
								...
								<div class="story-card">
									...
									<div class="story-wraper ">
										<img src="{{asset('/frontend/images/resources/story-card5.jpg')}}" alt="">
										<div class="users-dp">
											<img src="{{asset('/frontend/images/resources/user3.jpg')}}" alt="">
										</div>
									...
									<div class="story-wraper">
										<img src="{{asset('/frontend/images/resources/story-card2.jpg')}}" alt="">
										<div class="users-dp">
											<img src="{{asset('/frontend/images/resources/user7.jpg')}}" alt="">
										</div>
									...
									<div class="user-post">
										<div class="friend-info">
											<figure>
												...
												<img alt="" src="{{asset('images/resources/user7.jpg')}}">
											</figure>
											<div class="friend-name">
												<div class="more">
												...
												<ins>
													<a title="verified" href="time-line.html">{{$post->userId}}</a> Post Audio</ins>
												<span><i class="icofont-globe"></i> published: {{$post->created_at}}</span>
											</div>
											<div class="post-meta">
												<p>
													{{$post->caption}}
							...
							<div class="col-lg-3">
								<aside class="sidebar static right">
									<div class="widget">
										...
										<ul class="ak-groups">
											<li>
												<figure><img src="{{asset('/frontend/images/resources/your-group1.jpg')}}" alt=""></figure>
												<div class="your-grp">
											...
											<li>
												<figure><img src="{{asset('/frontend/images/resources/your-group2.jpg')}}" alt=""></figure>
												<div class="your-grp">
