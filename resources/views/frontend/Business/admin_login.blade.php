...
<head>
    ...
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('business_assets/css/themify.css')}}">

    <!-- slick icon-->
    <link rel="stylesheet" type="text/css" href="{{asset('business_assets/css/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('business_assets/css/slick-theme.css')}}">

    <!-- jsgrid css-->
    <link rel="stylesheet" type="text/css" href="{{asset('business_assets/css/jsgrid.css')}}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form action="{{url('business/admin/login', $business_id->id)}}" method="POST" class="form-horizontal auth-form">
                                    @method('POST')   
                                    @csrf
                                    ...
                                    @endif
                                        ...
                                        <input type="hidden" name="id" value="{{$business_id->id}}">
...
<script src="{{asset('business_assets/js/slick.js')}}"></script>

<!-- Jsgrid js-->
<script src="{{asset('business_assets/js/jsgrid/jsgrid.min.js')}}"></script>
<script src="{{asset('business_assets/js/jsgrid/griddata-invoice.js')}}"></script>
<script src="{{asset('business_assets/js/jsgrid/jsgrid-invoice.js')}}"></script>
