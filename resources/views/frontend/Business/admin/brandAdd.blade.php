...
<body>
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form action="{{route('vandor.BusinessBrandStore')}}" method="post" enctype="multipart/form-data">
      @csrf  
      @method('POST')
      <div class="col-md-6">
        <input type="hidden" name="business_id" value="{{$BusinessDetails->id}}">
        <input type="text" name="brandName" placeholder="Business Brand" class="form-control">
