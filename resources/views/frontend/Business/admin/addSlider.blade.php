...
<body>
  <div class="panel panel-default">
    <div class="panel-heading">
      ...
      <form action="{{route('vandor.BusinessSliderStore')}}" method="post" enctype="multipart/form-data">
      @csrf  
      @method('POST')
      <div class="col-md-6">
        ...
        <input type="text" name="discount" placeholder="Discount Content" class="form-control">
        <input type="text" name="title" placeholder="Slider Title" class="form-control">
        <input type="file" name="image" placeholder="Brand Image" class="form-control">
