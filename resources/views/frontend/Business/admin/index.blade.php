                        ...
                        <div class="card o-hidden  widget-cards">
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget">
                                    ...
                                    @php 
                                        $totalProduct = DB::table('vendor_products')->where('business_id', $BusinessDetails->id)->count();
                                        $totalOrder = DB::table('order_details')->where('businessId', $BusinessDetails->id)->count();
                                        $sellEarn = DB::table('order_details')->where('businessId', $BusinessDetails->id)->sum('totalprice');
                                        $comi_value = 6;
                                        $total_comission = $sellEarn * $comi_value /100

                                        @endphp
                                        <h3 class="mb-0">$ <span class="counter"><?php echo $totalProduct; ?></span><small> This Month</small></h3>
                                    </div>
                            ...
                            <div class="bg-primary card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Order</span>
                                        <h3 class="mb-0">$ <span class="counter"><?php echo $totalOrder; ?></span><small> This Month</small></h3>
                                    </div>
                                    <div class="icons-widgets">
                    ...
                    <div class="col-xl-3 col-md-6 xl-50">
                        <div class="card o-hidden widget-cards">
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Sell Earnings</span>
                                        <h3 class="mb-0">$ <span class="counter"><?php echo $sellEarn; ?></span><small> This Month</small></h3>
                                    </div>
                                    <div class="icons-widgets">
                    ...
                    <div class="col-xl-3 col-md-6 xl-50">
                        <div class="card o-hidden widget-cards">
                            <div class="bg-success card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Comission</span>
                                        <h3 class="mb-0">$ <span class="counter"><?php echo $total_comission; ?></span><small> This Month</small></h3>
                                    </div>
                                    <div class="icons-widgets">
